...
| Google Antigravity CLI (`agy`)                       | ✅ via `.agents/skills/` (Gemini CLI sunset 2026-06-18)                                                                                            | ⚠️ via `hooks/antigravity/` adapter — **written, not live-verified**, against undocumented hook internals (#4262)                | canonical `.agents/skills/` install; `agy plugin import gemini` for the legacy ext                                                         | `checked:antigravity 2026-09-16` |
| Antigravity IDE (desktop)                            | ✅ via `.agents/skills/` (Gemini Code Assist IDE sunset 2026-06-18)                                                                                | ⚠️ same `hooks/antigravity/` adapter, same caveat (#4262)                                                                        | canonical `.agents/skills/` install (same project path as the CLI)                                                                         | `checked:antigravity 2026-09-16` |
