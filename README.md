...
| `jus-block-no-verify.sh`                          | `PreToolUse Bash`               | Blocks `--no-verify`, `-n`, and the environment variables that skip git hooks: `HUSKY=0`, `LEFTHOOK=0`, `LEFTHOOK_EXCLUDE`, `SKIP`, `PRE_COMMIT_ALLOW_NO_CONFIG`                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `jus-block-accepted-manifest-edit.sh`             | `PreToolUse Bash`               | Blocks a `jus api PATCH` that edits the description of an accepted or cancelled ticket                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `jus-ticket-claim-nudge.sh`                       | `UserPromptSubmit`              | When a prompt names a ticket, hands the agent the ticket and the command that starts it (non-blocking)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
